        ...
        <section className="relative hidden overflow-hidden bg-[#111827] lg:flex lg:flex-col lg:justify-between">
          ...
          <div className="relative px-10 pb-20">
            ...
            <h2 className="max-w-lg text-4xl font-bold leading-tight tracking-tight text-white">
              ...
              <span className="text-[#8b7cff]">here.</span>
            </h2>

            <p className="mt-5 max-w-md text-sm leading-7 text-gray-400">
              Create your SkillSync AI account and get personalized insights
              to improve your skills, resume and career opportunities.
            </p>

            <div className="mt-9 grid max-w-md grid-cols-3 gap-3">
              <div className="rounded-xl border border-white/10 bg-white/[0.04] p-3">
                <p className="text-lg font-bold text-white">AI</p>
                <p className="mt-1 text-[9px] text-gray-500">Powered</p>
              </div>
          ...
          <div className="w-full max-w-[430px]">
            ...
            <div className="mb-7">
              ...
              <p className="mt-2 text-sm leading-6 text-[#6b7280]">
                Start building a smarter path toward your career goals.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="h-12 w-full rounded-xl border border-[#e5e7eb] bg-white px-4 text-sm text-[#111827] outline-none transition placeholder:text-[#9ca3af] focus:border-[#635bff] focus:ring-4 focus:ring-[#635bff]/10 disabled:bg-gray-50"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    minLength={6}
                    disabled={loading}
                    className="h-12 w-full rounded-xl border border-[#e5e7eb] bg-white px-4 pr-14 text-sm text-[#111827] outline-none transition placeholder:text-[#9ca3af] focus:border-[#635bff] focus:ring-4 focus:ring-[#635bff]/10 disabled:bg-gray-50"
                  />
              ...
              <div className="flex items-start gap-3 pt-1">
                <input
                  ...
                  required
                  disabled={loading}
                  className="mt-0.5 h-4 w-4 rounded border-gray-300 accent-[#635bff]"
                />
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#635bff] text-sm font-semibold text-white shadow-lg shadow-[#635bff]/20 transition hover:bg-[#5046e5] disabled:cursor-not-allowed disabled:opacity-70"
              >
                {loading ? (
                  <>
            ...
            <div className="mt-7 flex items-center justify-center gap-2 text-[10px] text-[#9ca3af]">
              <span>🔒</span>
